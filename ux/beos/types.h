...
#ifndef UX_BEOS_TYPES_H_
# define UX_BEOS_TYPES_H_              1
...
typedef UX_INT64_ fsblkcnt_t;

/* fsfilcnt_t: Used for filesystem file counts */
typedef UX_INT64_ fsfilcnt_t;
